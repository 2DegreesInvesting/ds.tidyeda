...
meetup-series. It covers the minimum elements of a defensive workflow, and of
the data-science toolkit you'll need during this series.
...
variable](https://r4ds.had.co.nz/exploratory-data-analysis.html#cat-cont). We'll
also discuss some ways to make the code of your plots clearer using "noise
